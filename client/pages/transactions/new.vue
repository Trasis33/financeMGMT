  ...
  <div>
    ...
    <form @submit.prevent="handleSubmit" class="mt-8 space-y-6">
      ...
      <div class="flex justify-end">
        <NuxtLink
          to="/transactions"
          class="mr-4 bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
        >
          Cancel
        </NuxtLink>
        <button
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMessage.value = error.message || 'An error occurred while saving the transaction'
  }
}
